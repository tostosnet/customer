<?php
$page_title = 'All Uncompleted Orders';
    ...
    <div class="card">
        <div class="card-header">
            <div class="header-elements-inline">
                <h5 class="card-title font-weight-semibold">All Uncompleted Orders</h5>
                <div class="header-elements">
                    <span>Total uncompleted orders: </span>
        ...
        <!-- <div class="tab-content card-body p-0"> -->
            ...
            <div class="table-responsive">
                ...
                <div id="table-placeholder" <?= (!$empty) ? "style='display:none; font-size: 16px;'" : '' ?>>
                    <p class="text-center p-3">No cancelled orders</p>
                </div>
            <?php $empty = true ?>
        </div>
        <!-- /tabs content -->
